...
namespace FurinaArchive.Tests.Infrastructure.Persistence.Sqlite
{
    public sealed class SqliteWishRecordRepositoryTests
    {
        ...
        {
            string diretory = Path.Combine(Path.GetTempPath(),"FurinaArchiveTests",Guid.NewGuid().ToString("N"));
